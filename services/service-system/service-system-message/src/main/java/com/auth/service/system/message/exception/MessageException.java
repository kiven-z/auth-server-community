...
/**
 * 消息模块业务异常，语义以 {@link SystemResultCode} 为来源，可携带 i18n 占位参数
 *
 * @author Bunny
 */
@Getter
public class MessageException extends RuntimeException implements I18nMessageProvider {
	 ...
	 */
	public MessageException(SystemResultCode resultCode, Object... args) {
	 ...
	 * @param args i18n 占位参数
	 */
	public MessageException(SystemResultCode resultCode, Throwable cause, Object... args) {
